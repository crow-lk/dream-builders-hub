      ...
      <section className="py-20 md:py-32 bg-secondary relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[...Array(3)].map((_, i) => (
              <Card key={i} className="animate-pulse border-border rounded-sm">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-5xl font-bold mt-4 text-foreground">
            Top-Rated <span className="text-primary italic">Consultants</span>
          </h2>
              ...
              {consultants.map((consultant, index) => (
                ...
                >
                  <motion.div
                    ...
                    className="p-2"
                  >
                    <Card className="h-full bg-card border-border hover:border-primary/30 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group rounded-sm">
                      <CardContent className="p-6">
                        <div className="flex items-start gap-4">
                          <motion.div
                            whileHover={{ scale: 1.1, rotate: 5 }}
                            className="w-16 h-16 rounded-sm bg-primary/10 border border-primary/20 flex items-center justify-center flex-shrink-0"
                          >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2 mt-3 text-sm text-muted-foreground bg-secondary rounded-sm px-3 py-1.5 w-fit border border-border/50">
        ...
        >
          <Link to="/contact">
            <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground group rounded-sm uppercase tracking-wider text-xs">
